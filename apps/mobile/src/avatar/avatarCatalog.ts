...
export const EYE_STYLES = ['angry', 'happy', 'mini', 'narrow', 'pissed', 'round', 'sad', 'small', 'suspicious', 'tall'];

export const EAR_STYLES = ['big', 'bitten', 'mini', 'monk', 'monkey', 'normal', 'pressed', 'protruding', 'small', 'tall'];

export const NOSE_STYLES = ['ball', 'big', 'fat', 'flat', 'mini', 'oink', 'pointy', 'rounded', 'small', 'straight'];

export const MOUTH_STYLES = ['confident', 'frown', 'grimace', 'grit', 'happy', 'laugh', 'neutral', 'pursed', 'sad', 'small', 'smile', 'surprise'];

export const HAIR_COLORS = ['black', 'blonde', 'blue', 'brown', 'green', 'pink', 'purple', 'red', 'turquoise', 'white'];

export const HAIR_STYLES = ['afro', 'bald', 'bobcut', 'bow', 'bows', 'bubbles', 'dcut', 'long', 'mane', 'middle_part', 'mohawk', 'ponytail', 'short', 'spikes', 'tip', 'toupee', 'vcut'];

export const BROW_COLORS = ['black', 'blonde', 'blue', 'brown', 'green', 'pink', 'purple', 'red', 'turquoise', 'white'];
export const BROW_STYLES = ['aggressive', 'angry', 'confident', 'disheveled', 'happy', 'innocent', 'nice', 'normal', 'pity', 'sad', 'thick', 'unibrow', 'worry', 'wrapping'];

export const HAT_COLORS = ['black', 'black_leather', 'blue', 'bronze', 'brown_leather', 'gold', 'green', 'grey', 'iron', 'lime', 'orange', 'pink', 'purple', 'red', 'silver', 'turquoise', 'white', 'white_leather', 'yellow'];
export const HAT_STYLES = ['bandana', 'beanie', 'cowboy', 'engineer', 'fedora', 'hood', 'knight', 'ranger', 'soldier', 'tall', 'trapper', 'warrior'];
...
export const MOUSTACHE_COLORS = ['black', 'blonde', 'blue', 'brown', 'green', 'pink', 'purple', 'red', 'turquoise', 'white'];
export const MOUSTACHE_STYLES = ['bandit', 'cowboy', 'dali', 'dallas', 'elder', 'horseshoe', 'hungarian', 'moebius', 'pencil', 'professor', 'toothbrush', 'zorro'];
...
export function getLayers(config: AvatarConfig, eyeFrame: 1 | 2 = 1, includeBg = true): { key: string; source: number }[] {
  const layers: ({ key: string; source: number | null } | null)[] = [
    ...
    { key: 'eyes', source: getAsset(eyeKey(config.race, config.eyeColor, config.eyeStyle, eyeFrame)) },
    ...
    config.moustache ? { key: 'moustache', source: getAsset(moustacheKey(config.moustache)) } : null,
    config.hair ? { key: 'hair', source: getAsset(hairKey(config.hair)) } : null,
    config.hat ? { key: 'hat', source: getAsset(hatKey(config.hat)) } : null,
  ];

  return layers.filter((l): l is { key: string; source: number } => l !== null && l.source !== null);
}
