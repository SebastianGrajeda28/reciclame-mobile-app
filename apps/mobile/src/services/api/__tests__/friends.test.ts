...
describe('getFriends', () => {
  ...
  test('Debería mapear correctamente las filas de la RPC a FriendSummary (snake_case → camelCase)', async () => {
    ...
    expect(friend.lastActivityAt).toBeInstanceOf(Date);
  ...
  test('Debería manejar amigos sin avatar (avatarUrl undefined)', async () => {
    // Preparar
  ...
  test('Debería manejar amigos sin actividad reciente (lastActivityAt undefined)', async () => {
    // Preparar
