...
insert into public.bin_types (id, university_id, name, color, description, is_active) values
  ...
  ('33333333-3333-3333-3333-000000000002', '00000000-0000-0000-0000-000000000001', 'Contenedor de metales',            '#F2994A', 'Para latas y otros residuos metálicos.',             true),
  ...
  ('33333333-3333-3333-3333-000000000005', '00000000-0000-0000-0000-000000000001', 'Contenedor de residuos generales', '#4F4F4F', 'Para residuos no reciclables o contaminados.',       true),
  ('33333333-3333-3333-3333-000000000006', '00000000-0000-0000-0000-000000000001', 'Contenedor de residuos orgánicos', '#6FCF97', 'Para cáscaras de frutas o verduras.',                true),
  ('33333333-3333-3333-3333-000000000007', '00000000-0000-0000-0000-000000000001', 'Contenedor de pilas',              '#EB5757', 'Para pilas y baterías pequeñas.',                    true),
  ('33333333-3333-3333-3333-000000000008', '00000000-0000-0000-0000-000000000001', 'Contenedor RAEE',                  '#9B51E0', 'Para residuos eléctricos y electrónicos.',           true)
...
insert into public.recycling_point_bins (recycling_point_id, bin_type_id, is_active) values
  ...
  ('22222222-2222-2222-2222-000000000001', '33333333-3333-3333-3333-000000000002', true),
  ...
  ('22222222-2222-2222-2222-000000000002', '33333333-3333-3333-3333-000000000005', true),
  ('22222222-2222-2222-2222-000000000002', '33333333-3333-3333-3333-000000000006', true),
  ('22222222-2222-2222-2222-000000000003', '33333333-3333-3333-3333-000000000007', true),
  ('22222222-2222-2222-2222-000000000003', '33333333-3333-3333-3333-000000000008', true)
...
insert into public.map_waste_type_bin_types (university_id, waste_type_id, bin_type_id, is_active) values
  ...
  ('00000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-000000000003', '33333333-3333-3333-3333-000000000005', true),
  ('00000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-000000000004', '33333333-3333-3333-3333-000000000003', true),
  ('00000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-000000000005', '33333333-3333-3333-3333-000000000007', true),
  ('00000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-000000000006', '33333333-3333-3333-3333-000000000008', true),
  ('00000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-000000000007', '33333333-3333-3333-3333-000000000001', true),
  ('00000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-000000000008', '33333333-3333-3333-3333-000000000002', true),
  ('00000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-000000000009', '33333333-3333-3333-3333-000000000004', true),
  ('00000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-000000000010', '33333333-3333-3333-3333-000000000006', true)
