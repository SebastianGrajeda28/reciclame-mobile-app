-- Extends get_friends_with_profile to return avatar_config jsonb.
-- DROP + CREATE required because PostgreSQL does not allow changing RETURNS TABLE via CREATE OR REPLACE.
