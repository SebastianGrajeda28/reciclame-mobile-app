...
} from "@/modules/admin/components/InstructionStepsSection";
import InstructionStepsSection from "@/modules/admin/components/InstructionStepsSection";
import {
  createInstruction,
  getInstructions,
  restoreInstruction,
...
export default function InstructionsPage() {
  ...
  const createMutation = useMutation({
    mutationFn: (wasteTypeId: string) =>
      createInstruction(session!.access_token, {
