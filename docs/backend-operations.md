...
| Obtener amigos con perfil | Mobile | RPC | `get_friends_with_profile` | `friendships`, `users`, `user_profiles`, `user_progress`, `avatars`, `recycling_records`, `user_featured_medals`, `achievements`, `rewards` |
